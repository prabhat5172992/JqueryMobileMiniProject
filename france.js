...
{ 
	...
	$('#h21').append("<center>"+"<h1><a href='europe.html' class='ui-btn ui-btn-inline ui-shadow ui-corner-all ui-icon-back ui-btn-icon-notext' target='_self'>back</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+cn+"</h1>"+"</center>");
