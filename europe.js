...
{ 
	...
	$('#a').trigger('create');
	$('#countries').append('<li><a href="uk.html" target="_self"><h2>'+p1+'</h2></a></li>');
	$('#countries').append('<li><a href="italy.html" target="_self"><h2>'+p2+'</h2></a></li>');
	$('#countries').append('<li><a href="france.html" target="_self"><h2>'+p3+'</h2></a></li>');
	$('#countries').append('<li><a href="swiss.html" target="_self"><h2>'+p4+'</h2></a></li>');
